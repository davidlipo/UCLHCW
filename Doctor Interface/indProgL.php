...
<?php
    ...
    $query = mysqli_query($link, "SELECT levelLeft FROM attempts WHERE patientID = '$patientID' GROUP BY levelLeft ORDER BY levelLeft DESC");
    
    $levels = array();
    $i = 0;
    while($res = mysqli_fetch_assoc($query)){
        $levels[$i] = $res['levelLeft'];
        $i = $i+1;
    }
...
<html>
    ...
    <div id="primaryContainer" class="primaryContainer clearfix">
        ...
        <div id="formContainer" class="formContainer clearfix">
            <form id= "form" name="mainForm" method="post" action="indProgLGraph.php">
                ...
                <select name="leftLevel" id="dropdown1">
                </select> 
                <script>
